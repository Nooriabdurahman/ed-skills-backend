...
const quiz_history_controller_1 = require("./quiz-history-controller");
 ...
 */
router.get("/", quiz_history_controller_1.QuizHistoryController.getAllQuizHistory);
/**
 * @swagger
 ...
 */
router.get("/my-history", auth_1.auth, quiz_history_controller_1.QuizHistoryController.getMyQuizHistory);
/**
 * @swagger
 ...
 */
router.get("/user/:userId", quiz_history_controller_1.QuizHistoryController.getUserQuizHistory);
/**
 * @swagger
 ...
 */
router.get("/quiz/:quizId", quiz_history_controller_1.QuizHistoryController.getQuizHistoryByQuizId);
/**
 * @swagger
 ...
 */
router.get("/course/:courseId", quiz_history_controller_1.QuizHistoryController.getQuizHistoryByCourseId);
exports.default = router;
//# sourceMappingURL=quiz-history-routes.js.map