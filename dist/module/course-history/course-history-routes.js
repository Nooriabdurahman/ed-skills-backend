...
const course_history_controller_1 = require("./course-history-controller");
const auth_1 = require("../../common/midlewere/auth");
 ...
 */
router.post("/", auth_1.auth, course_history_controller_1.CourseHistoryController.trackCourseView);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get("/my-history", auth_1.auth, course_history_controller_1.CourseHistoryController.getMyCourseHistory);
/**
 * @swagger
 ...
 */
router.get("/user/:userId", course_history_controller_1.CourseHistoryController.getUserCourseHistory);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get("/check/:courseId", auth_1.auth, course_history_controller_1.CourseHistoryController.checkCourseViewed);
/**
 * @swagger
 ...
 *         description: Invalid Course ID
 */
router.get("/course/:courseId/viewers", course_history_controller_1.CourseHistoryController.getCourseViewers);
exports.default = router;
//# sourceMappingURL=course-history-routes.js.map